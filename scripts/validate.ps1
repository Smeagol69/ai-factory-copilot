...
$requiredFiles = @(
    ...
    'Source\AIFactoryCopilot\Public\AIFactoryCreativeResourceNode.h',
    'Source\AIFactoryCopilot\Private\AIFactoryCreativeResourceNode.cpp',
    'Source\AIFactoryCopilot\Public\AIFactoryCreativeNodeContent.h',
    'Source\AIFactoryCopilot\Private\AIFactoryCreativeNodeContent.cpp',
    'Source\AIFactoryCopilot\Public\AIFactoryCreativeNodeHologram.h',
    'Source\AIFactoryCopilot\Private\AIFactoryCreativeNodeHologram.cpp',
    'Source\AIFactoryCopilot\Public\AIFactoryCreativeNodeRCO.h',
    'Source\AIFactoryCopilot\Private\AIFactoryCreativeNodeRCO.cpp',
    'Source\AIFactoryCopilot\Public\AIFactoryCreativeNodePlacement.h',
    'Source\AIFactoryCopilot\Private\AIFactoryCreativeNodePlacement.cpp',
    'Source\AIFactoryCopilot\Public\AIFactoryWorldEditAccess.h',
    'Source\AIFactoryCopilot\Private\AIFactoryWorldEditAccess.cpp',
    'Config\Alpakit.ini',
...
if ($upstream) {
    ...
    $checks = @(
        ...
        @{ Path = 'Source\FactoryGame\Public\FGRecipe.h'; Pattern = 'TArray< TSoftClassPtr< UObject > > mProducedIn' },
        ...
        @{ Path = 'Source\FactoryGame\Public\FGSchematicManager.h'; Pattern = 'GiveAccessToSchematic' },
        @{ Path = 'Source\FactoryGame\Public\FGRecipeManager.h'; Pattern = 'IsRecipeAvailable' },
        @{ Path = 'Source\FactoryGame\Public\FGRecipeManager.h'; Pattern = 'void AddAvailableRecipe' },
        @{ Path = 'Source\FactoryGame\Public\FGRecipeManager.h'; Pattern = 'GetAllItemDescriptors' },
        ...
        @{ Path = 'Source\FactoryGame\Public\Replication\FGStaticReplicatedActor.h'; Pattern = 'cannot move after creation' },
        ...
        @{ Path = 'Source\FactoryGame\Public\Equipment\FGBuildGun.h'; Pattern = 'void GotoMenuState' },
        ...
        @{ Path = 'Source\FactoryGame\Public\FGPlayerState.h'; Pattern = 'FOnBuildableConstructedNew BuildableConstructedDelegate' },
        @{ Path = 'Source\FactoryGame\Public\FGLightweightBuildableSubsystem.h'; Pattern = 'static bool ResolveLightweightInstance' },
        @{ Path = 'Source\FactoryGame\Public\FGLightweightBuildableSubsystem.h'; Pattern = 'void InitializeFromTemporary' },
        @{ Path = 'Source\FactoryGame\Public\Buildables\FGBuildable.h'; Pattern = 'GetIsLightweightTemporary' },
        @{ Path = 'Source\FactoryGame\Public\FGLightweightBuildableBlueprintLibrary.h'; Pattern = 'GetLightweightBuildableInstanceFromConvertedBuildableOrTemporary' },
        @{ Path = 'Source\FactoryGame\Public\Equipment\FGBuildGun.h'; Pattern = 'void TraceForBuildingSample' },
        @{ Path = 'Plugins\AbstractInstance\Source\AbstractInstance\Public\AbstractInstanceManager.h'; Pattern = 'bool ResolveHit' },
        @{ Path = '..\UnrealEngine-CSS\Engine\Source\Runtime\Engine\Classes\Engine\World.h'; Pattern = 'OnWorldPreActorTick' },
        @{ Path = '..\UnrealEngine-CSS\Engine\Source\Runtime\Engine\Classes\Engine\World.h'; Pattern = 'OnWorldPostActorTick' },
        ...
        @{ Path = 'Source\FactoryGame\Public\Buildables\FGBuildableResourceExtractorBase.h'; Pattern = 'DisconnectExtractableResource' },
        @{ Path = 'Source\FactoryGame\Public\Buildables\FGBuildable.h'; Pattern = 'PreSerializedToBlueprint' },
        @{ Path = 'Source\FactoryGame\Public\Buildables\FGBuildable.h'; Pattern = 'PostSerializedToBlueprint' },
        @{ Path = 'Source\FactoryGame\Public\Buildables\FGBuildable.h'; Pattern = 'PostSerializedFromBlueprint' },
        @{ Path = 'Source\FactoryGame\Public\Resources\FGResourceNode.h'; Pattern = 'void InitResource' },
        @{ Path = 'Source\FactoryGame\Public\Hologram\FGHologram.h'; Pattern = 'mCanBePlacedInBlueprintDesigner' },
        @{ Path = 'Source\FactoryGame\Public\FGBlueprintSubsystem.h'; Pattern = 'mBlacklistedDesignerBuildables' },
